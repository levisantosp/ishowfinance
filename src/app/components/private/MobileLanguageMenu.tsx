...
export default function MobileLanguageMenu({ isOpen }: Props) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className='flex flex-col gap-1 absolute top-25 right-8 rounded-2xl border border-gray-500 w-40 z-20 bg-[#171717]'
          >
            <div
